...
void copyArrayElements(int originalArray[100], int copyArray[100],short originalArrayLength, short& copyArrayLength) {
...
int main() {
	...
	copyArrayElements(Array1, Array2, array1Length, array2Length);
